...
Dans ce contexte, la technique de synthèse optimale consiste à minimiser l'erreur quadratique $\epsilon$ par rapport aux coefficients $\Omega=\{\widehat{a}_1,\cdots,\widehat{a}_L,\widehat{b}_0,\cdots,\widehat{b}_M \}$  de la partie récursive et non-récursive du filtre. Cette technique de synthèse optimale est généralement difficile à appliquer car elle nécessite de minimiser une fonction compliquée dans un espace de dimension $L+M+1$. 
